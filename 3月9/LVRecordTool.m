...
- (void)playRecordingFile {
    ...
    NSString *testStr = [self.recordFileUrl absoluteString];   //url>string
    NSLog(@"LVRecordTool :: playRecordingFile  =last one== path = %@",testStr);
...
- (NSURL *)getFilePath {
    ...
    NSURL* filePath = self.recordFileUrl;
    NSString * urlStr = [filePath absoluteString];
    NSLog(@"Error setting audio session active! %@",urlStr);
